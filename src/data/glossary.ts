...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    ...
    acronym: 'UACS',
    short:
      'The Philippine government-wide coding framework that identifies financial transactions consistently across budgeting, accounting, and reporting.',
  },
  {
    id: 'general-provision',
    term: 'General provision',
    short:
      'A provision in an appropriations law that states a rule applying across government or to the broad scope named in the provision.',
  },
  {
    id: 'special-provision',
    term: 'Special provision',
    short:
      'A provision attached to a particular agency, fund, program, or item that may state its purpose, conditions, release rules, or reporting requirements.',
  },  {
    id: 'budget-call',
    term: 'Budget call',
    short:
